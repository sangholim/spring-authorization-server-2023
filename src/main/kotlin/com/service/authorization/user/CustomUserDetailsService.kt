...
class CustomUserDetailsService(
    ...
    fun loadUserById(id: String): UserDTO {
        val user = userService.getById(id) ?: throw Exception("없는 회원 입니다")
        val roles = userRoleService.getAllBy(user.id).map { it.name.toString() }
